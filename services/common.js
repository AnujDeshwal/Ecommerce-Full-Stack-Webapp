...
exports.sendMail = async function({to,subject,text,html}) {
  ...
  // very important if you write async before function so then it will return a promise , here you can see that here it is returning a string but if you write async so it will wrap this string inside a promise and we are expecting a string , but we will get promise so this is wrong 
           ...
           <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
             ...
             <tr>
               <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                 <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="anujdeshwal95@gmail.com">contact us</a>.</p>
               </td>
             </tr>
             <!-- end copy -->
             <!-- start receipt table -->
